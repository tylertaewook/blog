...
This article will showcase my vehicle prototype Orbitron along with a short story behind the building scene. Then, I'll introduce you to the highlight: a clever algorithm I built singlehandedly based on a straightforward physics concept.
